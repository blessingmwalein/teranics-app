<template>
  <MainLayout :contact="contact" :about="about">
    ...
    <div class="main-banner-with-large-shape-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-12">
            <div class="main-banner-white-content">
              <div
                class="tag wow fadeInLeft"
              ...
              <div class="banner-btn">
                <a
                  href="about-1.html"
                  class="default-btn wow fadeInRight"
                  data-wow-delay="200ms"
                  data-wow-duration="1000ms"
                  >Read More <i class="ri-arrow-right-line"></i><span></span
                ></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-7 col-md-12">
            <div class="main-banner-image">
              <img
                src="assets/images/main-banner/banner-two/img1.png"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img2.png"
                class="wow fadeInDown"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img4.png"
                class="wow fadeInDown"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img5.png"
                class="wow fadeInUp"
                data-wow-delay="1200ms"
                data-wow-duration="1000ms"
                alt="image"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img6.png"
                class="wow fadeInLeft"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img7.png"
                class="wow fadeInDown"
                data-wow-delay="1500ms"
                data-wow-duration="1000ms"
                alt="image"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img8.png"
                class="wow fadeInDown"
                data-wow-delay="1200ms"
                data-wow-duration="1000ms"
                alt="image"
              ...
              />
              <img
                src="assets/images/main-banner/banner-two/img9.png"
                class="wow fadeInDown"
      ...
      <div class="main-banner-shape-5">
        <img
          src="assets/images/main-banner/banner-two/shape-1.png"
          alt="image"
        />
      </div>
      <div class="main-banner-shape-6">
        <img
          src="assets/images/main-banner/banner-two/shape-2.png"
          alt="image"
        />
      </div>
      <div class="main-banner-shape-7">
        <img
          src="assets/images/main-banner/banner-two/shape-3.png"
          alt="image"
        />
      </div>
      <div class="main-banner-shape-8">
        <img
          src="assets/images/main-banner/banner-two/shape-4.png"
          alt="image"
        />
      </div>
      <div class="main-banner-large-shape">
        <img
          src="assets/images/main-banner/banner-two/large-shape.png"
          alt="image"
        />
      </div>
    </div>
    ...
    <div class="video-area pt-100">
      ...
      <div class="video-shape-1" data-speed="0.08" data-revert="true">
        <img src="assets/images/video/shape-1.png" alt="image" />
      </div>
      <div class="video-shape-2" data-speed="0.08" data-revert="true">
    ...
    <div class="services-area pt-100 pb-70">
      <div class="container">
        <div class="section-title">
          ...
          <p>
            Best security, IT consulting, cloud based solutions , designing web,
            mobile development and hosting services
          </p>
        </div>
      ...
      <div class="services-shape-5" data-speed="0.06" data-revert="true">
        <img src="assets/images/services/shape-5.png" alt="image" />
      </div>
    </div>
    <!-- End Services Area -->
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6">
              <div class="single-fun-fact">
                ...
                <h3>
                  <span class="odometer" data-count="3230">20</span>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-fun-fact">
                ...
                <h3>
                  <span class="odometer" data-count="3026">30</span>
                  <span class="sign-icon">+</span>
                </h3>
                <p>Case Solved</p>
              </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-fun-fact">
                ...
                <h3>
                  <span class="odometer" data-count="320">10</span>
                  <span class="sign-icon">+</span>
                </h3>
                <p>Winning Awards</p>
              </div>
